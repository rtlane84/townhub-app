...
export const GetMyBusinessResponse = zod.object({
  ...
  "notifyNewOrdersByNtfy": zod.boolean().optional(),
  "notifyAppointmentRequestsByNtfy": zod.boolean().optional(),
  ...
  "appointmentRequestsEntitled": zod.boolean().optional().describe('Whether the business subscription plan includes the appointment_requests feature. Public appointment UI must require this plus storefrontMode APPOINTMENT.\n'),
...
export const UpdateBusinessBody = zod.object({
  ...
  "buttonColor": zod.string().nullish(),
  "bannerText": zod.string().nullish(),
  "type": zod.enum(['FOOD_VENDOR', 'COFFEE_SHOP', 'BAKERY', 'GROCERY', 'FLORIST', 'GARDEN_MARKET', 'RETAIL_STORE', 'BUILDING_SUPPLY', 'SERVICE_PROVIDER', 'RECREATION', 'FUNERAL_SERVICE', 'GENERAL', 'SALON']).optional().describe('What the business is (identity\/category). How it operates (ordering, appointments, mobile schedule, etc.) is modeled separately via storefrontMode, fulfillment flags, and isMobileBusiness.\n')
})
