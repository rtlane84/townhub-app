...
export interface Business {
  ...
  /** Whether the business subscription plan includes the appointment_requests feature. Public appointment UI must require this plus storefrontMode APPOINTMENT.
   */
