...
export function AppMarketingHero() {
  return (
    <section className="relative pt-28 pb-16 md:pt-40 md:pb-24 overflow-x-clip bg-background">
      <div className="container mx-auto px-4 md:px-8 max-w-[1280px] relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          {/* Dual-phone composition: back phone peeks clearly on mobile. */}
          <div className="relative w-full min-h-[420px] sm:min-h-[520px] md:min-h-[640px] lg:min-h-[720px] flex justify-center items-center mt-8 lg:mt-0">
            ...
            <div className="relative w-full max-w-[380px] sm:max-w-[440px] h-[420px] sm:h-[520px] md:h-[640px] lg:h-[700px]">
