...
const METADATA_LABELS: Record<string, string> = {
  ...
  connectWebhookConfigured: "Connect webhook configured",
  platformWebhookConfigured: "Platform webhook configured",
  legacyWebhookConfigured: "Legacy webhook configured",
  configIssueCount: "Config issue count",
  ...
  stripeApiReachable: "Stripe API reachable",
  platformChargesEnabled: "Platform charges",
  platformPayoutsEnabled: "Platform payouts",
  platformRequirementsDueCount: "Platform requirements due",
  platformDisabledReason: "Platform disabled reason",
  restrictedBusinessCount: "Restricted businesses",
  pendingConnectBusinessCount: "Pending Connect businesses",
