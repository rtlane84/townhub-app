      ...
      <input
        ...
        className={cn(
          ...
          (type === "date" || type === "time" || type === "datetime-local") &&
            "box-border min-w-0 max-w-full appearance-none [&::-webkit-calendar-picker-indicator]:ml-0 [&::-webkit-date-and-time-value]:min-w-0 [&::-webkit-datetime-edit]:min-w-0 [&::-webkit-datetime-edit]:max-w-full",
          className
        )}
        ref={ref}
        {...props}
