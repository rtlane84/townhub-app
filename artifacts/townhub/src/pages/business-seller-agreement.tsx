 ...
 * Preserve the effective date and accepted version for historical audit records.
 */
export default function BusinessSellerAgreement() {
  return (
    <article className="container mx-auto max-w-3xl px-4 py-10 sm:py-14">
      ...
      <h1 className="mt-2 font-serif text-3xl font-bold sm:text-4xl">TownHaven Business Seller Agreement</h1>
      <div className="prose prose-slate mt-8 max-w-none dark:prose-invert">
        <p>
          This agreement applies to a business or authorized representative that applies to list, sell, or
          accept requests through TownHaven. It supplements the <Link href="/terms-of-service">TownHaven Terms of Service</Link>.
        </p>
        ...
        <p>
          ...
          Online card payments are processed through your Stripe-connected account. TownHaven subscription fees are
          separate from customer order payments. Tax collection, reporting, and remittance responsibilities remain
          subject to the final written direction of TownHaven&apos;s tax adviser and applicable law.
        </p>
        ...
        <p>
          ...
          service to defraud customers or payment providers. TownHaven may remove content, pause ordering, or suspend
        ...
        <p>
          You keep ownership of content you provide, and grant TownHaven a non-exclusive right to host, reproduce,
          ...
          or as otherwise permitted by the customer and TownHaven&apos;s privacy practices.
        </p>
        ...
        <p>
          ...
          managed through Stripe where applicable. TownHaven may suspend or end access for nonpayment, an inactive or
        ...
        <p>
          To the extent permitted by law, you will defend and indemnify TownHaven and LaneTech LLC from third-party claims
