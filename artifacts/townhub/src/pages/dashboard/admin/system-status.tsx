      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-sm">
              Production dashboard for platform health, monitoring, and business metrics
            </p>
          </div>
        ...
        {isDevelopment && (
          <Alert data-testid="dev-hint">
            ...
            <AlertDescription className="text-sm">
              <span className="font-medium">Local development.</span> Optional services like email, SMS, Stripe, and
              background jobs are often intentionally disabled locally. Not configured statuses are expected — focus on
              Database and Authentication for core platform health.
            </AlertDescription>
          </Alert>
        )}
        ...
        {isError && (
          <Alert variant="destructive" data-testid="health-error">
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription className="text-sm">
              <span className="font-medium">Unable to load full system health.</span>{" "}
        ...
        <PlatformSection
          ...
          description="Infrastructure and integrations — each section loads independently if others fail."
        ...
        <PlatformSection
          ...
          description="Troubleshooting tools for notifications, API errors, and platform audit events."
        ...
        >
          <div className="space-y-4">
            ...
            />
            {health ? (
              <ApiErrorLogPanel errors={health.apiErrors ?? []} isDevelopment={isDevelopment} />
            ) : (
              !isLoading && (
                <p className="text-sm text-muted-foreground">
                  API error log will appear once system health loads.
                </p>
              )
            )}
            {health ? (
