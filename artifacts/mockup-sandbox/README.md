...
Isolated Vite workspace for UI prototyping with shadcn primitives. It is **not** the TownHaven production app and must not be treated as a source of product behavior.
