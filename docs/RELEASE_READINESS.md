...
| OPS-001 | P0 | Recovery | Production restore drill is not verified | Managed backups enabled and a restore drill recorded before real orders | In progress: R2 bucket and GitHub secrets are configured; manual production backup run succeeded on 2026-07-15 (run `29389309625`); restore drill and nightly schedule remain |
